...
public abstract class NetworkBoundResource<ResultType, RequestType> {
    ...
    private void fetchFromNetwork(LiveData<ResultType> dbSource) {
        ...
        createCall(new EmResultCallBack<LiveData<RequestType>>() {
            @Override
                ...
                mThreadManager.runOnMainThread(() -> {
                    result.addSource(apiResponse, response-> {
                        ...
                        if(response != null) {
                            ...
                            fetchFailed(EmErrorCode.EM_ERR_UNKNOWN, dbSource, null);
                        }
                    });
                });
     ...
     */
    @MainThread
    protected abstract void createCall(EmResultCallBack<LiveData<RequestType>> callBack);
